...
impl Board {
    ...
    pub fn new_2() -> Self {
        ...
        //? const solution: [Move; 22] = [Move::Up(Piece(6, 4)), Move::Right(Piece(3, 4)), Move::Down(Piece(1, 4)), Move::Down(Piece(1, 5)), Move::Down(Piece(3, 4)), Move::Right(Piece(3, 2)), Move::Down(Piece(1, 3)), Move::Left(Piece(3, 4)), Move::Right(Piece(3, 1)), Move::Left(Piece(3, 6)), Move::Left(Piece(3, 4)), Move::Right(Piece(5, 4)), Move::Right(Piece(4, 2)), Move::Right(Piece(5, 2)), Move::Up(Piece(5, 1)), Move::Up(Piece(7, 3)), Move::Left(Piece(4, 5)), Move::Right(Piece(5, 3)), Move::Right(Piece(3, 1)), Move::Left(Piece(5, 6)), Move::Down(Piece(3, 3)), Move::Left(Piece(5, 4))];
        // timed long (81)
        // b.pieces = [
        //     [false, false, true, true, true, false, false],
        //     [false, false, true, true, true, false, false],
        ...
        b.nb_pieces = b.pieces.iter().map(|row| row.iter().filter(|p| **p).count()).sum::<usize>() as u32;
        b
    }
